let citation =[
    ...
    "Je souffre de girlnextdooritis où le gars est ami avec toi et c'est tout.",
    "C'est une nouvelle année. Un nouveau départ. Et les choses vont changer.",
    "Je ne veux jamais tellement changer que les gens ne puissent pas me reconnaître.",
    "Je ne changerai jamais, mais je ne resterai jamais le même non plus",
    "C'est une nouvelle année. Un nouveau départ. Et les choses vont changer.",
    "Peu importe ce qui se passe dans la vie, soyez bon avec les gens. Être bon avec les gens est un merveilleux héritage à laisser derrière vous.",
    "Je ne veux jamais tellement changer que les gens ne puissent pas me reconnaître.",
    "Je suis intimidé par la peur d'être moyen.",
    ...
    "Qu'est-ce que tu préfères : te faire battre par quelqu'un que tu aimes ou faire l'amour a quelqu'un que tu détestes ?",
  ...
  , "Chaque baiser est une fleur dont la racine est le coeur.",
   "Il n'a plus assez de musique dans son coeur pour faire danser sa vie",
           ...
           "Tu trouveras, dans la joie ou dans la peine, ma triste main pour soutenir la tienne, mon triste coeur pour écouter le tien.",
            ...
            "Quand tu te lèves le matin, remercie pour la lumière du jour, pour ta vie et ta force. Remercie pour la nourriture et le bonheur de vivre. Si tu ne vois pas de raison de remercier, la faute repose en toi même.",
             ...
             "C'est seulement quand on a trouvé la raison de mourir que l'on oubli celle de vivre.",
              "Si la nuit tu pleures le soleil, tes larmes t'empêcheront de voir les étoiles.", "« Il vaut mieux penser le changement que changer le pansement. »",
                "« Même les plus cons ont leur jour de gloire : leur anniversaire. »",
                  "« Puisqu'il faut bien un jour pousser son dernier soupir, autant que ce soit le jour de son anniversaire, au moins ça peut aider à éteindre les bougies. »",
                    ...
                    "De mes larmes j'ai fait un océan dans lequel j'ai noyé tous ceux qui nous ont séparé.",
   ...
   "J'ai tout sauf toi, donc rien puisque tu es tout, et que je ne t'ai pas.",
   ...
   "Dans la vie on ne peut pas avoir la certitude absolue mais s'il y a une chose dont on peut être sure c'est que rien ne dure.",
  ...
  "Le coeur ne ment jamais.",
   ...
   "Si au crépuscule, Tu as l'impression d'avoir 4 testicules Ne te prends pas pour Hercules, c'est juste qu'on t'encule ...",
   ...
   "Tu m'as demandé de choisir entre toi et ma vie, j'ai choisi ma vie et tu es partie sans comprendre, que ma vie c'est toi!",
   ...
   "Qui êtes vous pour juger de la vie que je vis ? Je sais que je ne suis pas parfait et je ne vis pas pour l'être ! Mais avant de commencer à pointer le doigt, assurez-vous que vos mains sont propres.",
  ...
  "Si cet amour existe uniquement dans mes rêves... Ne me réveille pas.",
   ...
   "C'est parce que le coeur ne ment pas qu'il est facile de le blesser.",
